  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.top}>
        ...
        <div className={styles.brand}>
          ...
          <p className={styles.tagline}>
            Your trusted financial partner in Vaishali, Bihar. Expert guidance
            on loans and insurance to help every family achieve their dreams.
          </p>
        </div>
      ...
      <div className={styles.bottom}>
        <p>
          &copy; {new Date().getFullYear()} AK Loan &amp; Insurance Consultant.
          All rights reserved.
        </p>
        <p>
